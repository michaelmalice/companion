			...
			if (message.address.match(/^\/press\/bank\/\d+\/\d+$/)) {
				...
				if (message.args.length > 2) {
					...
					if (typeof r === 'number' && typeof g === 'number' && typeof b === 'number') {
						...
						this.bank.changeField(parseInt(a[3]), parseInt(a[4]), 'bgcolor', col, true)
					}
				}
				...
				if (message.args.length > 2) {
					...
					if (typeof r === 'number' && typeof g === 'number' && typeof b === 'number') {
						...
						this.bank.changeField(parseInt(a[3]), parseInt(a[4]), 'color', col, true)
					}
				}
				...
				if (message.args.length > 0) {
					...
					if (typeof text === 'string') {
						...
						this.bank.changeField(parseInt(a[3]), parseInt(a[4]), 'text', text, true)
					}
				}
